...
class NewsletterGenerateRequest(BaseModel):
    ...
    min_quality: float = Field(0.5, ge=0.0, le=1.0, description="Minimum quality score threshold")
    ...
    min_word_count: int = Field(150, ge=0, le=5000, description="Exclude very short items")
