    ...
    <div className="min-h-screen bg-ai-gradient-soft">
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
            <h2 className="text-3xl font-bold bg-ai-gradient bg-clip-text text-transparent">
          ...
          {stats.map((stat, index) => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
                ...
                className="bg-white/80 backdrop-blur-sm overflow-hidden shadow-lg rounded-lg border border-primary-200 hover:shadow-xl transition-all duration-300"
            >
                <div className="p-5">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
            ...
            className="bg-white/80 backdrop-blur-sm shadow-lg rounded-lg border border-primary-200 mb-8"
          >
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium bg-ai-gradient bg-clip-text text-transparent mb-4">
                Quick Actions
              </h3>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <button 
                  onClick={handleCreateNewsletter}
                  className="relative group bg-white/90 backdrop-blur-sm p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary-500 rounded-lg border border-primary-200 hover:border-primary-400 hover:shadow-lg hover:bg-white transition-all duration-300 cursor-pointer"
                  aria-label="Create a new AI-powered newsletter"
                >
                  <div>
                  ...
                  <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-primary-400 transition-colors">
                ...
                <button 
                  ...
                  className="relative group bg-white/90 backdrop-blur-sm p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary-500 rounded-lg border border-primary-200 hover:border-green-400 hover:shadow-lg hover:bg-white transition-all duration-300 cursor-pointer"
                  aria-label="View newsletter analytics and performance"
                >
                  <div>
                    <span className="rounded-lg inline-flex p-3 bg-green-50 text-green-600 ring-4 ring-white group-hover:bg-green-100 transition-colors">
                  ...
                  <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-green-400 transition-colors">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </span>
                ...
                <button 
                  ...
                  className="relative group bg-white/90 backdrop-blur-sm p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary-500 rounded-lg border border-primary-200 hover:border-yellow-400 hover:shadow-lg hover:bg-white transition-all duration-300 cursor-pointer"
                  aria-label="Manage account settings and preferences"
                >
                  <div>
                    <span className="rounded-lg inline-flex p-3 bg-yellow-50 text-yellow-600 ring-4 ring-white group-hover:bg-yellow-100 transition-colors">
                      <CogIcon className="h-6 w-6" />
                    </span>
                  </div>
                  <div className="mt-4">
                    <h3 className="text-lg font-medium text-gray-900 group-hover:text-yellow-700 transition-colors">
                      <span className="absolute inset-0" aria-hidden="true" />
                      Settings
                    </h3>
                    <p className="mt-2 text-sm text-gray-500 group-hover:text-gray-600 transition-colors">
                  ...
                  <span className="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-yellow-400 transition-colors">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </span>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
            ...
            className="bg-white/80 backdrop-blur-sm shadow-lg rounded-lg border border-primary-200"
          >
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium bg-ai-gradient bg-clip-text text-transparent mb-4">
                Recent Newsletters
